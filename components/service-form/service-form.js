...
Component({
  ...
  pageLifetimes: {
        ...
        //监听小程序的显示和隐藏,上传图片，预览封面图也会触发show,hide 所以需要增加一个标识 this.data.resetForm
      show() {
          console.log('show')
  ...
  methods: {
      ...
      submit() {
           //selectComponent获取组件的实例 实例上调用 validate方法 可能是weui的写法
           console.log('selectComponent',this.selectComponent('#form'))
